...
type RangeForth<From extends Iteration, To extends Iteration, fmt extends Format = 's', T extends List = []> = {
...
type RangeBack<From extends Iteration, To extends Iteration, fmt extends Format = 's', T extends List = []> = {
