 ...
 * type test1 = A.Is<'x', 'x' | 0, 'r-extends'> // true
 * type test2 = A.Is<'x', 'x' | 0, 'equals'>  // false

 * type test4 = A.Is<'x' | 0, 'x'>            // boolean
 * type test5 = A.Is<'x' | 0, 'x', 'r-extends'> // boolean
...
export type Is<A extends any, A1 extends any, match extends Match = 'default'> = {
    ...
    'r-contains': Contains<A,  A1>
    'r-extends' : Extends<A,   A1>
    'l-contains': Contains<A1, A>
    'l-extends' : Extends<A1,  A>
    'equals'    : Equals<A1,   A>
}[match]
