...
type _ZipObj<TProp extends string[], TField extends List, O extends object = {}, I extends Iteration = IterationOf<'0'>> = {
 ...
 * @example
 */
export type ZipObj<TKeys extends string[], TFields extends List> =
