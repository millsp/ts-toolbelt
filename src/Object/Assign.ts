...
@hidden
*/
export type _Assign<O extends object, Os extends List<object>, depth extends Depth> = __Assign<
  O,
  Os,
  depth
> extends infer X
...
> = O extends unknown ? (Os extends unknown ? _Assign<O, Os, depth> : never) : never
