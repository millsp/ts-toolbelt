...
declare type PlusPositive<N1 extends Iteration, N2 extends Iteration> = {
    0: PlusPositive<Next<N1>, Prev<N2>>;
    1: N1;
    2: number;
}[Pos<N2> extends 0 ? 1 : number extends Pos<N2> ? 2 : 0];
declare type PlusNegative<N1 extends Iteration, N2 extends Iteration> = {
    0: PlusNegative<Prev<N1>, Next<N2>>;
    1: N1;
    2: number;
}[Pos<N2> extends 0 ? 1 : number extends Pos<N2> ? 2 : 0];
export declare type _Plus<N1 extends Iteration, N2 extends Iteration> = _IsNegative<N2> extends true ? PlusNegative<N1, N2> : PlusPositive<N1, N2>;
