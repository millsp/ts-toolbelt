import {Test, B} from '../src/ts-toolbelt'
...
checks([
    check<B.And<B.True, B.True>,            1,          Test.Pass>(),
    check<B.And<B.True, B.False>,           0,          Test.Pass>(),
    check<B.And<B.False, B.True>,           0,          Test.Pass>(),
    check<B.And<B.False, B.False>,          0,          Test.Pass>(),
...
checks([
    check<B.Or<B.True, B.True>,         1,          Test.Pass>(),
    check<B.Or<B.True, B.False>,        1,          Test.Pass>(),
    check<B.Or<B.False, B.True>,        1,          Test.Pass>(),
    check<B.Or<B.False, B.False>,       0,          Test.Pass>(),
