...
checks([
    ...
    check<T.Filter<T, number, 'loose'>,    FILTER_T_NUMBER_LOOSE,       Test.Pass>(),
...
type INTERSECT_T_T1_NUMBER_LOOSE =  [
    1,
    2,
    '3' | undefined,
    'xxxx',
...
checks([
    ...
    check<T.Intersect<T, T1, 'loose'>,      INTERSECT_T_T1_NUMBER_LOOSE,    Test.Pass>(),
])
...
// No test needed (same as T.Merge)
...
checks([
    ...
    check<T.Select<T, number, 'loose'>,    SELECT_T_NUMBER_LOOSE,       Test.Pass>(),
...
// No test needed (same as O.Writable)
