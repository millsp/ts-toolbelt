import {Test, N, M} from '../src/index'
import {Plus} from '../src/Number/Plus'
...
checks([
    check<N.Absolute<'-1px', 's', M.Iteration.Pixel>,   '1px',      Test.Pass>(),
...
checks([
    check<N.Greater<'9px', '10px', M.Iteration.Pixel>,      0,          Test.Pass>(),
    ...
    check<N.Greater<never, '10'>,                           0 | 1,      Test.Pass>(),
])
...
checks([
    check<N.GreaterEq<'9px', '10px', M.Iteration.Pixel>,    0,          Test.Pass>(),
    ...
    check<N.GreaterEq<never, '10'>,                         0 | 1,      Test.Pass>(),
])
...
checks([
    check<N.IsNegative<'-10px', M.Iteration.Pixel>,     1,          Test.Pass>(),
...
checks([
    check<N.IsPositive<'-10px', M.Iteration.Pixel>,     0,          Test.Pass>(),
...
checks([
    check<N.IsZero<'0px', M.Iteration.Pixel>,   1,          Test.Pass>(),
...
checks([
    check<N.Lower<'9px', '10px', M.Iteration.Pixel>,    1,          Test.Pass>(),
...
checks([
    check<N.LowerEq<'9px', '10px', M.Iteration.Pixel>,      1,          Test.Pass>(),
...
checks([
    check<N.Max<'1px' | '2px', 's', M.Iteration.Pixel>,     '2px',      Test.Pass>(),
...
checks([
    check<N.Min<'1px' | '2px', 's', M.Iteration.Pixel>,     '1px',      Test.Pass>(),
...
checks([
    check<N.Minus<'9px', '10px', 's', M.Iteration.Pixel>,   '-1px',             Test.Pass>(),
...
checks([
    check<N.Negate<'9px', 's', M.Iteration.Pixel>,      '-9px',         Test.Pass>(),
...
checks([
    check<N.Plus<'9px', '10px', 's', M.Iteration.Pixel>,    '19px',                 Test.Pass>(),
...
checks([
    check<N.Range<'0px', '2px', '->', 's', M.Iteration.Pixel>,  ['0px', '1px', '2px'],                              Test.Pass>(),
